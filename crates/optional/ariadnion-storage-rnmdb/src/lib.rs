...
pub use migration::{
    ...
    identity_invitation_migration, identity_organization_migration, identity_password_migration,
    identity_session_migration, identity_users_migration, platform_initial_migration,
