...
This inventory records every tracked production Cargo lock graph. Package identities are deduplicated by exact name, version, and source. First-party path packages define the resolution boundary but are not third-party records.

## Coverage summary

- Tracked production lockfiles: 43.
- Unique resolved package records: 285.
- First-party path package records: 43.
- External Git package records: 15.
- Registry package records: 227.
- Canonical upstream projects: 128.
- Package-version license and notice files: 445.

Selected alternatives are recorded from package metadata, canonical source records, and the exact Cargo manifest and lockfile resolution.
...
| `bundles/complete/Cargo.lock` | `a23c47d5522ce2013380114c0b85cbf62cfd5dbd9925ddd7d5dfbca731cf2015` | 69674 | 300 |
| `bundles/edge/Cargo.lock` | `f565d723b2faf01953c3660d2d406ffa5b6e2b2ae1f83a5b95fb8e5773e70ec1` | 3124 | 16 |
| `bundles/standard/Cargo.lock` | `d3914070f52ee16d8811c04a3209fcff089559017b37447eba151bbbce886b9e` | 69674 | 300 |
...
| `crates/optional/ariadnion-storage-asset/Cargo.lock` | `83bcc34ad9ef2fa2daf847a589688f5f072c7956fcf5280f3ecceb40725ee8e7` | 13671 | 60 |
...
| `crates/optional/ariadnion-storage-rnmdb/Cargo.lock` | `c65898c2fecd1a510a169af3d901cdbb51c59ebe1b77afa4afaeca810fe1bdea` | 61703 | 258 |
...
Canonical upstream: <https://github.com/sunfishcode/ambient-authority>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ambient-authority` | `0.0.2` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `e9d4ee0d472d1cd2e28c97dfa124b3d8d992e10eb0a035f33f5d12e3a177ba3b` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `ambient-authority 0.0.2`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/ambient-authority/0.0.2/download) -> [`.ahcl/THIRD-PARTY-LICENSES/ambient-authority-0.0.2/LICENSE-MIT`](THIRD-PARTY-LICENSES/ambient-authority-0.0.2/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `ambient-authority 0.0.2`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/ambient-authority/0.0.2/download) -> [`.ahcl/THIRD-PARTY-LICENSES/ambient-authority-0.0.2/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/ambient-authority-0.0.2/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `ambient-authority 0.0.2`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/ambient-authority/0.0.2/download) -> [`.ahcl/THIRD-PARTY-LICENSES/ambient-authority-0.0.2/LICENSE-APACHE`](THIRD-PARTY-LICENSES/ambient-authority-0.0.2/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `ambient-authority 0.0.2`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/ambient-authority/0.0.2/download) -> [`.ahcl/THIRD-PARTY-LICENSES/ambient-authority-0.0.2/COPYRIGHT`](THIRD-PARTY-LICENSES/ambient-authority-0.0.2/COPYRIGHT) (SHA-256 `d00d6d48df2db6f91e4ca9c656e5e30782d5becf52bb3e5bfd0aff467bd37781`; 897 bytes).
...
Canonical upstream: <https://github.com/bytecodealliance/cap-std>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `cap-fs-ext` | `4.0.3` | direct runtime; transitive | `registry+https://github.com/rust-lang/crates.io-index` | `56ff379b70af8e08307a8f65e7040c7301cb4a572538ade16b4984f0da77847f` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `cap-primitives` | `4.0.3` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `8b5f74729fd2f44701d1a8eb47e906cdb3ccd9ec0f02baad85a744b791940b18` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `cap-std` | `4.0.3` | direct runtime; transitive | `registry+https://github.com/rust-lang/crates.io-index` | `c1ec78e242cfa2cfe276807ac2ecc00315a6c97786977414bcd1c3963b6c91b8` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `cap-fs-ext 4.0.3`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/cap-fs-ext/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/LICENSE-MIT`](THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `cap-primitives 4.0.3`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/cap-primitives/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-primitives-4.0.3/LICENSE-MIT`](THIRD-PARTY-LICENSES/cap-primitives-4.0.3/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `cap-std 4.0.3`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/cap-std/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-std-4.0.3/LICENSE-MIT`](THIRD-PARTY-LICENSES/cap-std-4.0.3/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `cap-fs-ext 4.0.3`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/cap-fs-ext/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `cap-primitives 4.0.3`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/cap-primitives/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-primitives-4.0.3/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/cap-primitives-4.0.3/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `cap-std 4.0.3`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/cap-std/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-std-4.0.3/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/cap-std-4.0.3/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `cap-fs-ext 4.0.3`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/cap-fs-ext/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/COPYRIGHT`](THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/COPYRIGHT) (SHA-256 `5b3d8a674979e158328c57f5c4cc12150df79d0bdf12c86eafc2e9c6006a2d4e`; 869 bytes).
- `cap-std 4.0.3`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/cap-std/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-std-4.0.3/COPYRIGHT`](THIRD-PARTY-LICENSES/cap-std-4.0.3/COPYRIGHT) (SHA-256 `6b1691fdee3b03c3946696a7be125fcf50eff310b9486fac850c1b8aea91478b`; 857 bytes).
- `cap-fs-ext 4.0.3`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/cap-fs-ext/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/LICENSE-APACHE`](THIRD-PARTY-LICENSES/cap-fs-ext-4.0.3/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `cap-primitives 4.0.3`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/cap-primitives/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-primitives-4.0.3/LICENSE-APACHE`](THIRD-PARTY-LICENSES/cap-primitives-4.0.3/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `cap-std 4.0.3`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/cap-std/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-std-4.0.3/LICENSE-APACHE`](THIRD-PARTY-LICENSES/cap-std-4.0.3/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `cap-primitives 4.0.3`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/cap-primitives/4.0.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/cap-primitives-4.0.3/COPYRIGHT`](THIRD-PARTY-LICENSES/cap-primitives-4.0.3/COPYRIGHT) (SHA-256 `a8799c2a07dabcb8d52481f885c5ab7000acb8a4d3cd9503fbcb97c84d350e65`; 885 bytes).
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `cfg-if` | `1.0.4` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `9330f8b2ff13f34540b44e946ef35111825727b38d33286ef986142615121801` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `cfg_aliases` | `0.2.2` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `f079e83a288787bcd14a6aea84cee5c87a67c5a3e660c30f557a3d24761b3527` | `MIT` | `MIT` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
Canonical upstream: <https://github.com/bytecodealliance/fs-set-times>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `fs-set-times` | `0.20.3` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `94e7099f6313ecacbe1256e8ff9d617b75d1bcb16a6fddef94866d225a01a14a` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `fs-set-times 0.20.3`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/fs-set-times/0.20.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/fs-set-times-0.20.3/LICENSE-MIT`](THIRD-PARTY-LICENSES/fs-set-times-0.20.3/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `fs-set-times 0.20.3`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/fs-set-times/0.20.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/fs-set-times-0.20.3/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/fs-set-times-0.20.3/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `fs-set-times 0.20.3`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/fs-set-times/0.20.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/fs-set-times-0.20.3/LICENSE-APACHE`](THIRD-PARTY-LICENSES/fs-set-times-0.20.3/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `fs-set-times 0.20.3`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/fs-set-times/0.20.3/download) -> [`.ahcl/THIRD-PARTY-LICENSES/fs-set-times-0.20.3/COPYRIGHT`](THIRD-PARTY-LICENSES/fs-set-times-0.20.3/COPYRIGHT) (SHA-256 `e196ffeb5ab101e9ec8bbe395c9f367c5380ee2d28c47e5c03371523798a9af7`; 877 bytes).
...
Canonical upstream: <https://github.com/sunfishcode/io-extras>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `io-extras` | `0.19.0` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `20fd6de4ccfcc187e38bc21cfa543cb5a302cb86a8b114eb7f0bf0dc9f8ac00f` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `io-extras 0.19.0`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/io-extras/0.19.0/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-extras-0.19.0/LICENSE-MIT`](THIRD-PARTY-LICENSES/io-extras-0.19.0/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `io-extras 0.19.0`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/io-extras/0.19.0/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-extras-0.19.0/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/io-extras-0.19.0/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `io-extras 0.19.0`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/io-extras/0.19.0/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-extras-0.19.0/LICENSE-APACHE`](THIRD-PARTY-LICENSES/io-extras-0.19.0/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `io-extras 0.19.0`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/io-extras/0.19.0/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-extras-0.19.0/COPYRIGHT`](THIRD-PARTY-LICENSES/io-extras-0.19.0/COPYRIGHT) (SHA-256 `f0c1d22de8bd3b776a40f2691f08b84e91c7bafc78b72a51150e231002b88db3`; 865 bytes).

### io-lifetimes

Canonical upstream: <https://github.com/sunfishcode/io-lifetimes>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `io-lifetimes` | `2.0.4` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `06432fb54d3be7964ecd3649233cddf80db2832f47fec34c01f65b3d9d774983` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `io-lifetimes` | `3.0.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `2f0fb0570afe1fed943c5c3d4102d5358592d8625fda6a0007fdbe65a92fba96` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `io-lifetimes 2.0.4`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/io-lifetimes/2.0.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/LICENSE-MIT`](THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `io-lifetimes 3.0.1`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/io-lifetimes/3.0.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/LICENSE-MIT`](THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `io-lifetimes 2.0.4`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/io-lifetimes/2.0.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `io-lifetimes 3.0.1`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/io-lifetimes/3.0.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `io-lifetimes 2.0.4`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/io-lifetimes/2.0.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/COPYRIGHT`](THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/COPYRIGHT) (SHA-256 `495c30b45120f8af07cfa26eb9cb1ebfe8324560dca2b3b1e76cad1b9b6b489a`; 877 bytes).
- `io-lifetimes 3.0.1`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/io-lifetimes/3.0.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/COPYRIGHT`](THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/COPYRIGHT) (SHA-256 `495c30b45120f8af07cfa26eb9cb1ebfe8324560dca2b3b1e76cad1b9b6b489a`; 877 bytes).
- `io-lifetimes 2.0.4`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/io-lifetimes/2.0.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/LICENSE-APACHE`](THIRD-PARTY-LICENSES/io-lifetimes-2.0.4/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `io-lifetimes 3.0.1`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/io-lifetimes/3.0.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/LICENSE-APACHE`](THIRD-PARTY-LICENSES/io-lifetimes-3.0.1/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).

### ipnet

Canonical upstream: <https://github.com/krisprice/ipnet>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ipnet` | `2.12.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `6a756c3fac73139e83f14c2d742155dd2b78d3ee56597b419a0579b7bdd6dd78` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `ipnet 2.12.1`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/ipnet/2.12.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/ipnet-2.12.1/LICENSE-MIT`](THIRD-PARTY-LICENSES/ipnet-2.12.1/LICENSE-MIT) (SHA-256 `47dc9ff29128ddfb4d6a0435383c9f89120bc374dbcc1dd00b933a0b28aa7865`; 1062 bytes).
- `ipnet 2.12.1`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/ipnet/2.12.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/ipnet-2.12.1/LICENSE-APACHE`](THIRD-PARTY-LICENSES/ipnet-2.12.1/LICENSE-APACHE) (SHA-256 `87d9feb9238c6bd8e0024fc4733b06cff036f89f36d93b7df1c8a0549bbb7a5b`; 11352 bytes).
...
| `libc` | `0.2.189` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `3eaf3ede3fee6db1a4c2ee091bf8a8b4dccdc6d17f656fb07896ee72867612f2` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `linux-raw-sys` | `0.12.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `32a66949e030da00e8c7d4434b251670a91556f4144941d37452769c25d58a53` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock` |
...
Canonical upstream: <https://github.com/rustonaut/maybe-owned>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `maybe-owned` | `0.3.4` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `4facc753ae494aeb6e3c22f839b158aebd4f9270f55cd3c79906c45476c47ab4` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `maybe-owned 0.3.4`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/maybe-owned/0.3.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/maybe-owned-0.3.4/LICENSE-APACHE`](THIRD-PARTY-LICENSES/maybe-owned-0.3.4/LICENSE-APACHE) (SHA-256 `aecc100d0547aa3bcbe04bcf5cb87c7db0be11004602adfa5056edf8bb847b35`; 10834 bytes).
- `maybe-owned 0.3.4`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/maybe-owned/0.3.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/maybe-owned-0.3.4/LICENSE-MIT`](THIRD-PARTY-LICENSES/maybe-owned-0.3.4/LICENSE-MIT) (SHA-256 `ef2b3bbd7b718a7881253226313f103e89b379e1279681a3c1ebcb65a27d209d`; 1058 bytes).
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `nix` | `0.31.3` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `cf20d2fde8ff38632c426f1165ed7436270b44f199fc55284c38276f9db47c3d` | `MIT` | `MIT` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `block2` | `0.6.2` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `cdeb9d870516001442e364c5220d3574d2da8dc765554b4a617230d33fa58ef5` | `MIT` | `MIT` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
| `dispatch2` | `0.3.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `1e0e367e4e7da84520dedcac1901e4da967309406d1e51017ae1abfb97adbd38` | `Zlib OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
| `objc2-encode` | `4.1.0` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `ef25abbcd74fb2609453eb695bd2f860d389e457f67dc17cafc8b8cbc89d0c33` | `MIT` | `MIT` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `once_cell` | `1.21.4` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `9f7c3e4beb33f85d45ae3e3a1792185706c8e16d043238c593331cc7cd313b50` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock` |
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `rnmdb-catalog` | `0.1.0` | direct runtime; transitive | `git+https://github.com/czxieddan/RNovModularDB.git?rev=f35e636f3d32d2d0835a23e6d53fc3437e46707a#f35e636f3d32d2d0835a23e6d53fc3437e46707a` | `not applicable` | `LicenseRef-AHCL-1.1 OR LicenseRef-RNovModularDB-Commercial` | `LicenseRef-AHCL-1.1` | canonical Cargo manifest and lockfile resolution | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock` |
...
Selected license copy: `.ahcl/AHCL-1.1.md`.
Additional restrictions for this dependency selection: `none`.

License evidence:

- `rnmdb-catalog 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-catalog-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-catalog-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-cli 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-cli-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-cli-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-common 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-common-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-common-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-executor 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-executor-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-executor-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-fts 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-fts-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-fts-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-index 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-index-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-index-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-instance 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-instance-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-instance-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-planner 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-planner-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-planner-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-security 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-security-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-security-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-server 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-server-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-server-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-sql 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-sql-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-sql-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-storage 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-storage-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-storage-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-txn 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-txn-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-txn-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-types 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-types-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-types-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
- `rnmdb-udf 0.1.0`: repository verbatim license `.ahcl/AHCL-1.1.md` -> [`.ahcl/THIRD-PARTY-LICENSES/rnmdb-udf-0.1.0/AHCL-1.1.md`](THIRD-PARTY-LICENSES/rnmdb-udf-0.1.0/AHCL-1.1.md) (SHA-256 `41bfa8d3621494b84ba87a0b2a07748be339c10146787fe0d89ef7c38358d702`; 76078 bytes).
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ctrlc` | `3.5.2` | direct runtime; transitive | `registry+https://github.com/rust-lang/crates.io-index` | `e0b1fab2ae45819af2d0731d60f2afe17227ebb1a1538a236da84c93e9a60162` | `MIT/Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `errno` | `0.3.14` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `39cab71617ae0d63f51a36d69f866391735b51691dbda63cf6f96d042b63efeb` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock` |
...
Canonical upstream: <https://github.com/sunfishcode/rustix-linux-procfs>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `rustix-linux-procfs` | `0.1.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `2fc84bf7e9aa16c4f2c758f27412dc9841341e16aa682d9c7ac308fe3ee12056` | `Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `rustix-linux-procfs 0.1.1`: crate archive member [`LICENSE-MIT`](https://crates.io/api/v1/crates/rustix-linux-procfs/0.1.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/LICENSE-MIT`](THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/LICENSE-MIT) (SHA-256 `23f18e03dc49df91622fe2a76176497404e46ced8a715d9d2b67a7446571cca3`; 1023 bytes).
- `rustix-linux-procfs 0.1.1`: crate archive member [`LICENSE-Apache-2.0_WITH_LLVM-exception`](https://crates.io/api/v1/crates/rustix-linux-procfs/0.1.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/LICENSE-Apache-2.0_WITH_LLVM-exception`](THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/LICENSE-Apache-2.0_WITH_LLVM-exception) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
- `rustix-linux-procfs 0.1.1`: crate archive member [`LICENSE-APACHE`](https://crates.io/api/v1/crates/rustix-linux-procfs/0.1.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/LICENSE-APACHE`](THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/LICENSE-APACHE) (SHA-256 `a60eea817514531668d7e00765731449fe14d059d3249e0bc93b36de45f759f2`; 10847 bytes).
- `rustix-linux-procfs 0.1.1`: crate archive member [`COPYRIGHT`](https://crates.io/api/v1/crates/rustix-linux-procfs/0.1.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/COPYRIGHT`](THIRD-PARTY-LICENSES/rustix-linux-procfs-0.1.1/COPYRIGHT) (SHA-256 `d415a86ccfd794129666247cbbadebee7a6d0ac3ff701c76c07b0f9424f0307d`; 905 bytes).
...
| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `windows-link` | `0.2.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `f0805222e57f7521d6a62e36fa9163bc891acd422f971defe97d64e70d0a4fe5` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `Cargo.lock`; `bundles/complete/Cargo.lock`; `bundles/edge/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-api-admin/Cargo.lock`; `crates/optional/ariadnion-api-dispatch/Cargo.lock`; `crates/optional/ariadnion-api-domain/Cargo.lock`; `crates/optional/ariadnion-api-files/Cargo.lock`; `crates/optional/ariadnion-api-http/Cargo.lock`; `crates/optional/ariadnion-api-stream/Cargo.lock`; `crates/optional/ariadnion-audit-domain/Cargo.lock`; `crates/optional/ariadnion-audit-store/Cargo.lock`; `crates/optional/ariadnion-auth-api-key/Cargo.lock`; `crates/optional/ariadnion-auth-password/Cargo.lock`; `crates/optional/ariadnion-auth-session/Cargo.lock`; `crates/optional/ariadnion-cli-user/Cargo.lock`; `crates/optional/ariadnion-compose/Cargo.lock`; `crates/optional/ariadnion-config-domain/Cargo.lock`; `crates/optional/ariadnion-config-runtime/Cargo.lock`; `crates/optional/ariadnion-config-schema/Cargo.lock`; `crates/optional/ariadnion-diagnostics/Cargo.lock`; `crates/optional/ariadnion-invitation/Cargo.lock`; `crates/optional/ariadnion-job-runner/Cargo.lock`; `crates/optional/ariadnion-organization/Cargo.lock`; `crates/optional/ariadnion-principal-binding/Cargo.lock`; `crates/optional/ariadnion-protocol-openai/Cargo.lock`; `crates/optional/ariadnion-provider-dispatch/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-provider-mock/Cargo.lock`; `crates/optional/ariadnion-provider-sdk/Cargo.lock`; `crates/optional/ariadnion-rbac/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock`; `crates/optional/ariadnion-storage-backup/Cargo.lock`; `crates/optional/ariadnion-storage-domain/Cargo.lock`; `crates/optional/ariadnion-storage-maintenance/Cargo.lock`; `crates/optional/ariadnion-storage-migration/Cargo.lock`; `crates/optional/ariadnion-storage-outbox/Cargo.lock`; `crates/optional/ariadnion-storage-query/Cargo.lock`; `crates/optional/ariadnion-storage-restore/Cargo.lock`; `crates/optional/ariadnion-storage-rnmdb/Cargo.lock`; `crates/optional/ariadnion-storage-upgrade/Cargo.lock`; `crates/optional/ariadnion-user-domain/Cargo.lock`; `crates/optional/ariadnion-user-service/Cargo.lock` |
...
| `windows-sys` | `0.59.0` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `1e38bc4d79ed67fd075bcc251a1c39b32a1776bbe92e5bef1f0bf1f8c531853b` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows-sys` | `0.60.2` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `f2f500e4d28234f72040990ec9d39e3a6b950f9f22d3dba18416c35882612bcb` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
| `windows-targets` | `0.52.6` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `9b724f72796e036ab90c1021d4780d4d3d648aca59e491e6b98e725b84e99973` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows-targets` | `0.53.5` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `4945f9f551b88e0d65f3db0bc25c33b8acea4d9e41163edf90dcd0b19f9069f3` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_aarch64_gnullvm` | `0.52.6` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `32a4622180e7a0ec044bb555404c800bc9fd9ec262ec147edd5989ccd0c02cd3` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_aarch64_gnullvm` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `a9d8416fa8b42f5c947f8482c43e7d89e73a173cead56d044f6a56104a6d1b53` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_aarch64_msvc` | `0.52.6` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `09ec2a7bb152e2252b53fa7803150007879548bc709c039df7627cabbd05d469` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_aarch64_msvc` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `b9d782e804c2f632e395708e99a94275910eb9100b2114651e04744e9b125006` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_i686_gnu` | `0.52.6` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `8e9b5ad5ab802e97eb8e295ac6720e509ee4c243f69d781394014ebfe8bbfa0b` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_i686_gnu` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `960e6da069d81e09becb0ca57a65220ddff016ff2d6af6a223cf372a506593a3` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_i686_gnullvm` | `0.52.6` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `0eee52d38c090b3caa76c563b86c3a4bd71ef1a819287c19d586d7334ae8ed66` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-provider-http/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |
| `windows_i686_gnullvm` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `fa7359d10048f68ab8b09fa71c3daccfb0e9b559aed648a8f95469c27057180c` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
| `windows_i686_msvc` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `1e7ac75179f18232fe9c285163565a57ef8d3c89254a30685b57d83a38d326c2` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
| `windows_x86_64_gnu` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `9c3842cdd74a865a8066ab39c8a7a473c0778a3f29370b5fd6b4b9aa7df4a499` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
| `windows_x86_64_gnullvm` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `0ffa179e2d07eee8ad8f57493436566c7cc30ac536a3379fdf008f47f6bb7ae1` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
| `windows_x86_64_msvc` | `0.53.1` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `d6bbff5f0aada427a1e5a6da5f1f98158182f26556f345ac9e04d36d0ebed650` | `MIT OR Apache-2.0` | `Apache-2.0` | declared metadata and dependency policy | `crates/optional/ariadnion-storage-asset/Cargo.lock` |
...
- `windows-sys 0.59.0`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows-sys/0.59.0/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows-sys-0.59.0/license-apache-2.0`](THIRD-PARTY-LICENSES/windows-sys-0.59.0/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
- `windows-sys 0.60.2`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows-sys/0.60.2/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows-sys-0.60.2/license-apache-2.0`](THIRD-PARTY-LICENSES/windows-sys-0.60.2/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows-targets 0.53.5`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows-targets/0.53.5/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows-targets-0.53.5/license-apache-2.0`](THIRD-PARTY-LICENSES/windows-targets-0.53.5/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_aarch64_gnullvm 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_aarch64_gnullvm/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_aarch64_gnullvm-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_aarch64_gnullvm-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_aarch64_msvc 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_aarch64_msvc/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_aarch64_msvc-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_aarch64_msvc-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_i686_gnu 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_i686_gnu/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_i686_gnu-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_i686_gnu-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_i686_gnullvm 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_i686_gnullvm/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_i686_gnullvm-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_i686_gnullvm-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_i686_msvc 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_i686_msvc/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_i686_msvc-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_i686_msvc-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_x86_64_gnu 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_x86_64_gnu/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_x86_64_gnu-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_x86_64_gnu-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_x86_64_gnullvm 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_x86_64_gnullvm/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_x86_64_gnullvm-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_x86_64_gnullvm-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows_x86_64_msvc 0.53.1`: crate archive member [`license-apache-2.0`](https://crates.io/api/v1/crates/windows_x86_64_msvc/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_x86_64_msvc-0.53.1/license-apache-2.0`](THIRD-PARTY-LICENSES/windows_x86_64_msvc-0.53.1/license-apache-2.0) (SHA-256 `c16f8dcf1a368b83be78d826ea23de4079fe1b4469a0ab9ee20563f37ff3d44b`; 11351 bytes).
...
- `windows-sys 0.59.0`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows-sys/0.59.0/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows-sys-0.59.0/license-mit`](THIRD-PARTY-LICENSES/windows-sys-0.59.0/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
- `windows-sys 0.60.2`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows-sys/0.60.2/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows-sys-0.60.2/license-mit`](THIRD-PARTY-LICENSES/windows-sys-0.60.2/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows-targets 0.53.5`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows-targets/0.53.5/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows-targets-0.53.5/license-mit`](THIRD-PARTY-LICENSES/windows-targets-0.53.5/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_aarch64_gnullvm 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_aarch64_gnullvm/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_aarch64_gnullvm-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_aarch64_gnullvm-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_aarch64_msvc 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_aarch64_msvc/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_aarch64_msvc-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_aarch64_msvc-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_i686_gnu 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_i686_gnu/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_i686_gnu-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_i686_gnu-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_i686_gnullvm 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_i686_gnullvm/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_i686_gnullvm-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_i686_gnullvm-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_i686_msvc 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_i686_msvc/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_i686_msvc-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_i686_msvc-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_x86_64_gnu 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_x86_64_gnu/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_x86_64_gnu-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_x86_64_gnu-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_x86_64_gnullvm 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_x86_64_gnullvm/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_x86_64_gnullvm-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_x86_64_gnullvm-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).
...
- `windows_x86_64_msvc 0.53.1`: crate archive member [`license-mit`](https://crates.io/api/v1/crates/windows_x86_64_msvc/0.53.1/download) -> [`.ahcl/THIRD-PARTY-LICENSES/windows_x86_64_msvc-0.53.1/license-mit`](THIRD-PARTY-LICENSES/windows_x86_64_msvc-0.53.1/license-mit) (SHA-256 `c2cfccb812fe482101a8f04597dfc5a9991a6b2748266c47ac91b6a5aae15383`; 1141 bytes).

### winx

Canonical upstream: <https://github.com/sunfishcode/winx>

| Package | Version | Roles | Exact source | Cargo checksum | Declared license | Selected license | Selection basis | Lockfiles |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `winx` | `0.36.4` | transitive | `registry+https://github.com/rust-lang/crates.io-index` | `3f3fd376f71958b862e7afb20cfe5a22830e1963462f3a17f49d82a6c1d1f42d` | `Apache-2.0 WITH LLVM-exception` | `Apache-2.0 WITH LLVM-exception` | declared metadata and dependency policy | `bundles/complete/Cargo.lock`; `bundles/standard/Cargo.lock`; `crates/optional/ariadnion-storage-asset/Cargo.lock` |

License evidence:

- `winx 0.36.4`: crate archive member [`LICENSE`](https://crates.io/api/v1/crates/winx/0.36.4/download) -> [`.ahcl/THIRD-PARTY-LICENSES/winx-0.36.4/LICENSE`](THIRD-PARTY-LICENSES/winx-0.36.4/LICENSE) (SHA-256 `268872b9816f90fd8e85db5a28d33f8150ebb8dd016653fb39ef1f94f2686bc5`; 12243 bytes).
